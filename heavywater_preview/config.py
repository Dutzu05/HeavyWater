...
LOCAL_EGMS_DATA_DIR = DATA_DIR / "egms"
...
STABILITY_POINTS_NAME = "egms_stability_points.geojson"
STABILITY_SUMMARY_NAME = "stability_summary.json"
REPORT_INPUTS_NAME = "report_inputs.json"
WATER_RISK_POINTS_NAME = "water_risk_points.geojson"
WATER_RISK_CANALS_NAME = "water_risk_canals.geojson"
WATER_RISK_SITES_NAME = "water_risk_sites.geojson"
WATER_RISK_SUMMARY_NAME = "water_risk_summary.json"
EGMS_VERTICAL_NAME = "egms_vertical.geojson"
EGMS_HORIZONTAL_NAME = "egms_horizontal.geojson"
EGMS_COMBINED_NAME = "egms_combined.geojson"
...
EWDS_API_URL_ENV_VARS = ("EWDS_API_URL", "COPERNICUS_EWDS_API_URL")
EWDS_API_KEY_ENV_VARS = ("EWDS_API_KEY", "COPERNICUS_EWDS_API_KEY")
EGMS_TOKEN_ENV_VARS = ("EGMS_TOKEN", "COPERNICUS_EGMS_TOKEN")
EGMS_SOURCE_ENV_VARS = ("EGMS_ORTHO_VERTICAL_SOURCE",)
EGMS_RELEASE_ENV_VARS = ("EGMS_RELEASE",)

DEFAULT_BBOX_SIZE_KM = 20.0
WATER_SOURCE_EUHYDRO = "euhydro"
WATER_SOURCE_OVERPASS = "overpass"
DEFAULT_WATER_SOURCE = WATER_SOURCE_EUHYDRO
...
DEFAULT_COMMUNITY_MERGE_DISTANCE_M = 400.0
DEFAULT_TERRAIN_RESOLUTION_M = 30.0
DEFAULT_RIVER_METRIC_RESOLUTION_M = 10.0
DEFAULT_RIVER_METRIC_LOOKBACK_DAYS = 60
DEFAULT_EFAS_DAYS_BACK = 7
DEFAULT_STABILITY_BUFFER_M = 500.0
DEFAULT_DIFFERENTIAL_MOTION_THRESHOLD = 3.0
DEFAULT_GLOFAS_DAYS_BACK = 7
DEFAULT_COMMUNITY_PIXEL_AREA_M2 = 100.0
DEFAULT_PEOPLE_PER_CLUSTER_PIXEL = 1.0
DEFAULT_FARM_DEMAND_M3_DAY = 50.0
DEFAULT_EGMS_RELEASE = "2019_2023"
